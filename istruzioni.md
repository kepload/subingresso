...
13. ~~**A/B test copy popup_vetrina + blog_promo**~~ ✅ Risolto (23 mag 2026): rimossa la copy-lotteria. Popup visitatori ora "Iscriviti gratis e pubblica il tuo annuncio" (icona 🏪, no gambling-vibe). Blog_promo già sostituito dal box posteggi live. Da misurare se la conversion migliora ora che non c'è più la promessa-lotteria.
